...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(3, 20, 65, 0.6) 0%, rgba(56, 189, 248, 0.2) 100%)';
...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      ['--behind-glow-color' as any]: behindGlowColor ?? 'rgba(56, 189, 248, 0.45)',
            ...
            <div className="pc-content pc-avatar-content">
              {avatarUrl ? (
                ...
                <div className="pc-avatar-placeholder">
                  <div className="pc-avatar-placeholder-icon">
                    <span>SD</span>
                  </div>
                </div>
              )}
                  ...
                  <div className="pc-user-details">
                    <div className="pc-mini-avatar">
                      {miniAvatarUrl || avatarUrl ? (
                        ...
                        <span className="pc-mini-avatar-text">SD</span>
                      )}
                    </div>
